...
return (
        ...
        <Route path='/searched-profile'>
          {!isLoggedIn ? <Redirect to='/sign-in'/> : <SearchedProfile searchedProfile={searchedProfile} setSearchedProfileData={setSearchedProfileData} searchedProfileData={searchedProfileData} profileClicked={profileClicked} setProfileLike={setProfileLike}/>}
        </Route>
        <Route path = '*'>
